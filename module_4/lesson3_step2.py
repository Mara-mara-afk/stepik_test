...
class ProductPage(BasePage):
    ...
    def should_be_success_message_with_product_name(self, product_name):
        ...
        assert product_name in message, f"Expected '{product_name}' in message, got '{message}'"

    def should_be_basket_total_equal_product_price(self, product_price):
        total = self.browser.find_element(*self.BASKET_TOTAL).text
        assert total == product_price, f"Expected basket total '{product_price}', got '{total}'"
