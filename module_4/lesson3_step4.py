...
class ProductPage(BasePage):
    ...
    SUCCESS_MESSAGE_STRONG = (By.CSS_SELECTOR, "#messages .alert-success strong")
    ...
    def should_be_success_message_with_product_name(self, expected_name):
        message = self.browser.find_element(*self.SUCCESS_MESSAGE_STRONG).text
        assert expected_name == message, f"Expected product name '{expected_name}', got '{message}'"
